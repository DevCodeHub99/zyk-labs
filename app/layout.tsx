...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://zyklabs.in/og-image.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://zyklabs.in/og-image.webp'],
  },
  icons: {
    icon: [
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    url: 'https://zyklabs.in',
    logo: 'https://zyklabs.in/favicon/favicon-32x32.png',
    image: 'https://zyklabs.in/og-image.webp',
