...
/**
 * Shared layout for legal documents (Privacy, TOS, etc.)
 */
export default function LegalPage({ data, title, highlight }: LegalPageProps) {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div key={index} className="group relative">
                        <div className="grid md:grid-cols-[180px_1fr] gap-8 md:gap-12">
                            <div className="space-y-2">
                                <div className="text-[10px] font-black text-accent uppercase tracking-widest opacity-40 group-hover:opacity-100 transition-opacity">Section 0{index + 1}</div>
            ...
            <div className="mt-32 pt-12 border-t border-border/50 text-center">
                <p className="text-[10px] font-black text-foreground/20 uppercase tracking-[0.3em]">
                    Zyklabs Technical Standards & Compliance
                </p>
            </div>
        </div>
    </main>
