...
export default function PricingTeaser() {
  ...
  const displayPrice = getPlanPrice(buildPlan)
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-6 md:space-y-8">
            ...
            <p className="text-base md:text-xl text-foreground/60 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
              Transparent project fees and monthly support tiers designed for early-stage founders. No hidden costs,
            ...
            >
              ...
              <div className="mb-10">
                <div className="flex items-baseline gap-1">
                  <span className="text-5xl font-black tracking-tighter text-primary">{displayPrice}</span>
                  <span className="text-xs text-foreground/40 font-black uppercase tracking-widest">
                    {buildPlan.period}
                  </span>
                </div>
                <p className="text-[10px] text-foreground/40 mt-1 font-bold uppercase tracking-wider">
                  Most popular for new SaaS products
                </p>
              </div>
